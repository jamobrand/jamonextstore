  ...
  return (
    <>
      <Head
        ...
        description="This is the terms and condition for jamobrand.com"
      />
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
          ...
          <div className="layout-base max-w-3xl mx-auto my-5">
            ...
            <p className="text-lg-regular text-gray-700">
              Thank you for visiting and using JAMO BRAND. This is an agreement
              between you (“you” or “your”) and JAMO BRAND, a business
              registered in Kenya (“JAMO BRAND,” “we,” “us” or “our”) that
              governs your use of the JAMO BRAND.com website, any mobile app we
              may provide, and any related tools and services (collectively, the
              “Site”). When you access or use the Site in any way or express
              your consent to these terms in any other respect, you agree to be
              legally bound by these Terms and Conditions (“Terms”). Please make
              sure you review these Terms carefully, as they contain important
              information about your rights and obligations, including
                  ...
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500">
                        ...
                        or country of residence, or that you are the age of
                        majority in your state or country of residence and you
                  ...
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500 mb-2">
                        “JAMO BRAND Content” means all Content that JAMO BRAND
                        makes available through the Site, including any Content
                        licensed from a third party, but excluding User Content.
                        “Collective Content” means User Content and JAMO BRAND
                        Content. “Content” means text, graphics, images, music,
                        software, audio, video, information or other materials.
                        “Buyer” means a User who buys a product from a Listing
                        via the Site. “Seller” means a User who creates a
                        Listing to sell via the Site. “Listing” means a product
                        that is listed by a Seller as available for sale via the
                        Site. “Item” means a product listed for sale by Seller
                        or purchased by Buyer. “User” means a person who visits
                        our website, completes the JAMO BRAND account
                        registration process, or uses the Site in any other
                        respect, and include but are not limited to Sellers and
                        Buyers. “User Content” means all Content that a User
                        posts, uploads, publishes, submits or transmits to be
                        made available through the Site. “Tax” or “Taxes” mean
                        any sales taxes, value added taxes (VAT), digital
                        service tax (DST) and other similar , state or other
                  ...
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500 mb-2">
                        ...
                        quantities of any products or services that we offer.
              ...
              <Disclosure as="div" className="pt-6">
                {({ open }) => (
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500">
                        JAMO BRAND is an online marketplace designed to
                        facilitate the buying and selling of home decor
                        products. We are committed to providing a positive
              ...
              <Disclosure as="div" className="pt-6">
                {({ open }) => (
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500 mb-2">
                        Upon registration of your account you will be considered
                        a member of JAMO BRAND with user permissions eligible to
                        use JAMO BRANDS for permitted activities, including the
                        buying and selling of goods. You are responsible for
                        ...
                        password or account. We permit only one account per
                        person. You may not share your password with anyone
                        else. You may not provide false registration information
                        or select a user name that infringes third party rights
                        or misleads about your credibility or affiliation. You
                        agree to notify JAMO BRAND immediately on any
                        unauthorized use of your account, email, or password.
                        JAMO BRAND shall not be liable for any loss that you
                        incur as a result of someone else using your password,
                      ...
                      <p className="text-base text-gray-500">
                        ...
                        so directly through the Services by completing the
                        required forms. To the extent we make such features
                        available, you may also register to join JAMO BRAND or
                        you may log into your JAMO BRAND account by using your
                        third party social networking accounts, such as Facebook
                        (each social networking account, a “Third Party
                        Account). You may link your JAMO BRAND account with
                        Third Party Accounts by either: (i) providing your Third
                        Party Account login information to JAMO BRAND through
                        the Site; or (ii) allowing JAMO BRAND to access your
                        Third Party Account in accordance with the applicable
                        terms and conditions that govern your use of each Third
                        Party Account. You represent that you are entitled to
                        disclose your Third Party Account login information to
                        JAMO BRAND and/or grant JAMO BRAND access to your Third
                        Party Account (including, but not limited to, for use
                        for the purposes described herein), without breach by
                        you of any of the terms and conditions that govern your
                        use of the applicable Third Party Account and without
                        obligating JAMO BRAND to pay any fees or making JAMO
                        BRAND subject to any usage limitations imposed by such
                        third party service providers.
                      </p>

                      <p className="text-base text-gray-500">
                        By granting JAMO BRAND access to any Third Party
                        Accounts, you understand that JAMO BRAND will access,
                        make available and store (if applicable) any content
                        that you have provided to and stored in your Third Party
                        Account (“Third Party Account Content”) so that it is
                        available on and through the Services via your JAMO
                        BRAND account and your JAMO BRAND account profile page.
                        Depending on the Third Party Accounts you choose and
                        subject to the privacy settings that you have set in
                        such Third Party Accounts, personal information that you
                        post to your Third Party Accounts may be available on
                        and through your JAMO BRAND account on the Services and
                        may be visible to other Users. Unless otherwise
                        specified in these Terms, all Third Party Account
                        Content, if any, will be considered to be User Content
                        for all purposes of these Terms. PLEASE NOTE THAT YOUR
                        ...
                        SERVICE PROVIDERS. JAMO BRAND makes no effort to review
                        any Third Party Account Content for any purpose,
                        including but not limited to, for accuracy, legality or
                        non-infringement, and JAMO BRAND is not responsible for
                        any Third
                      </p>
                    </Disclosure.Panel>
                  </>
                  ...
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500">
                        ...
                        or under the same customer account, the same credit
                        card, and/or orders that use the same billing and/or
                        shipping address. In the event that we make a change to
                        or cancel an order, we may attempt to notify you by
                        ...
                        for all purchases made at our store. You agree to
                  ...
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500">
                        ...
                        products, or services of third-parties. We are not
                        liable for any harm or damages related to the purchase
                  ...
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      ...
                      <p className="text-base text-gray-500 mb-2">
                        ...
                        state regulations, rules, laws, or local ordinances; (d)
              ...
              <Disclosure as="div" className="pt-6">
                {({ open }) => (
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500">
                        We may change the Terms and the Services without notice,
                        and you are responsible for checking these Terms
                        periodically for revisions. All amended Terms are
                        effective upon our posting through the Site, and any use
                        of the Site after such revisions have been posted and
                        any opt in consent that you may provide through the
                        Services signifies your consent to the changes.
                      </p>
                    </Disclosure.Panel>
                  </>
                )}
                  ...
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500">
                        ...
                        a waiver of such right or provision. These Terms of
                        Service and any policies or operating rules posted by us
                        on this site or in respect to The Service constitutes
                        the entire agreement and understanding between you and
                        us and govern your use of the Service, superseding any
                        prior or contemporaneous agreements, communications and
                        proposals, whether oral or written, between you and us
                        (including, but not limited to, any prior versions of
                        the Terms of Service). Any ambiguities in the
                  ...
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base text-gray-500">
                        ...
                        construed in accordance with the laws of 00100 ,
                        Nairobi, KE .
                      </p>
                    </Disclosure.Panel>
                  </>
